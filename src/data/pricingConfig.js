...
export const PLAN_PRESETS = [
  ...
  {
    name: "Premium",
    description: "Croissance + rapports business analyst, stratégie, domaine et re-shoot à -50%.",
...
export const MODULE_CATALOG = [
  ...
  {
    id: "matterport-space",
    label: "Hébergement visite virtuelle",
    category: "Abonnement récurrent",
    description: "Hébergement de la visite virtuelle Matterport inclus dans l’abonnement.",
    icon: MapPinned,
  ...
  },
  {
    ...
    label: "App web immersive / overlay de base",
    category: "Application web / overlay",
    description: "Socle app web : avis Google, sections, points d’intérêt, menu et interface globale.",
    icon: WandSparkles,
    defaultSelected: true,
    recommended: true,
  ...
  {
    id: "booking-module",
    label: "Intégration vrai système de réservation",
    category: "Application web / overlay",
    description: "Connexion ou intégration du vrai parcours de réservation du client.",
    icon: FileText,
    defaultSelected: false,
    setupPublic: 500,
    setupMinimum: 250,
  ...
  },
  {
    ...
    category: "Application web / overlay",
    description: "Optimisation SEO/GEO du site immersif ou de la page principale.",
  ...
  },
  {
    ...
    category: "Application web / overlay",
    description: "Paramétrage d’une URL personnalisée pour présenter l’expérience comme un vrai site.",
    icon: MousePointerClick,
    defaultSelected: false,
    setupPublic: 100,
    setupMinimum: 50,
  ...
  },
  {
    ...
    category: "Application web / overlay",
    description: "Automatisation mail, CRM, Airtable, notification ou suivi des leads.",
    icon: Settings2,
    defaultSelected: false,
    setupPublic: 200,
    setupMinimum: 100,
  ...
  },
  {
    ...
    label: "Pop-up",
    category: "Application web / overlay",
    description: "Pop-up de conversion pour offre, réservation, abonnement ou demande de contact.",
    icon: Megaphone,
    defaultSelected: false,
    setupPublic: 80,
    setupMinimum: 40,
  ...
  },
  {
    ...
    category: "Application web / overlay",
    description: "Carte personnalisée pour gîtes, domaines, complexes, espaces ou parcours multi-zones.",
    icon: MapPinned,
    defaultSelected: false,
    setupPublic: 250,
    setupMinimum: 120,
  ...
  },
  {
    ...
    label: "Hébergement app web immersive",
    category: "Abonnement récurrent",
    description: "Mise en ligne, disponibilité, maintenance technique et hébergement de l’overlay.",
    icon: ShieldCheck,
    defaultSelected: true,
    recommended: true,
    setupPublic: 0,
  ...
  },
  {
    ...
    label: "Dashboard data comportementales",
    category: "Abonnement récurrent",
    description: "Dashboard complet : parcours, clics, zones fortes, conversions et signaux commerciaux.",
  ...
  },
  {
    ...
    label: "Rapports mensuels + accompagnement",
    category: "Abonnement récurrent",
    description: "Rapport KPI mensuel détaillé, analyse business analyst, stratégie et support prioritaire.",
    icon: Headphones,
    defaultSelected: false,
    setupPublic: 0,
    setupMinimum: 0,
  ...
  {
    id: "full-website",
    label: "Site web complet sur mesure",
    category: "Premium & accompagnement",
    description: "Structure SEO/GEO avancée, parcours complet, PMS ou paiement : à chiffrer au cas par cas.",
    icon: WandSparkles,
    defaultSelected: false,
    setupPublic: 2500,
    setupMinimum: 1200,
...
export const PROPERTY_PRESETS = [
  ...
  },
  {
    name: "Overlay seul",
    scope: "app",
    description: "App web immersive de base au-dessus d’une visite Matterport déjà existante.",
    moduleIds: ["web-app-immersive"],
  },
  {
    name: "App + réservation",
    scope: "app",
    description: "App web de base avec intégration du vrai système de réservation.",
    moduleIds: ["web-app-immersive", "booking-module"],
  },
  {
    name: "Site immersif complet",
    scope: "app",
    description: "App web convertie en site principal : toutes les options incluses, total 2 130 €.",
    moduleIds: [
      "web-app-immersive",
      "booking-module",
      "seo-geo",
  ...
  },
  {
    name: "Essentiel",
    scope: "subscription",
    description: "Hébergement visite virtuelle + app web immersive.",
    moduleIds: ["hosting-maintenance", "matterport-space"],
  },
  {
    name: "Croissance",
    scope: "subscription",
    description: "Essentiel + dashboard data comportementales + re-shoot -25%.",
    moduleIds: ["hosting-maintenance", "matterport-space", "analytics-dashboard"],
  },
  {
    name: "Premium",
    scope: "subscription",
    description: "Croissance + BA, rapports, stratégie, domaine et re-shoot -50%.",
    moduleIds: ["hosting-maintenance", "matterport-space", "analytics-dashboard", "monthly-updates-support"],
  },
  {
    name: "Pack complet",
    scope: "full",
    description: "Shooting + site immersif complet + abonnement performance.",
    moduleIds: [
      "interior-capture",
      "exterior-capture",
      "web-app-immersive",
